...
def plot(ax,input_type,adapt_mode):
    ...
    sweep_df['delta_specrad_r_a'] = sweep_df['specrad'] - sweep_df['r_a']


    sns.lineplot(ax=ax,data=sweep_df,x="sigm_e",y="delta_specrad_r_a",hue="r_t_cat",legend="full",palette="viridis",hue_norm=(0.5,1.8))
