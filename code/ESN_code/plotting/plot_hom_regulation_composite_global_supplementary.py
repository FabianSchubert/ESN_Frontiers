...
fig.savefig(os.path.join(PLOT_DIR,'hom_regulation_composite_global_suppl.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'hom_regulation_composite_global_suppl.png'),dpi=1000)
