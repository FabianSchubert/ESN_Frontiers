...
r_a.plot(ax1,'heterogeneous_identical_binary','global',col=colors[0],skip_steps=10)

r_a.plot(ax2,'heterogeneous_independent_gaussian','global',col=colors[0],skip_steps=10)

r_a.plot(ax3,'homogeneous_identical_binary','global',col=colors[0],skip_steps=10)

r_a.plot(ax4,'homogeneous_independent_gaussian','global',col=colors[0],skip_steps=10)
...
#specrad.plot(ax4,'heterogeneous_independent_gaussian','local','',col=colors[0])
...
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_composite_global_suppl.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_composite_global_suppl.png'),dpi=1000)
