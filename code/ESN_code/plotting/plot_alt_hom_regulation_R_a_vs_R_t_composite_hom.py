...
plot_R_a_vs_R_t.plot(ax2,'homogeneous_independent_gaussian','local')

plot_R_a_vs_R_t.plot(ax1,'homogeneous_identical_binary','local')
...
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_R_a_vs_R_t_composite_hom.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_R_a_vs_R_t_composite_hom.png'),dpi=1000)
