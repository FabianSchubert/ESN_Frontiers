...
import ESN_code.plotting.plot_R_a_over_R_t as plot_R_a_over_R_t
...
fig.savefig(os.path.join(PLOT_DIR,'R_a_over_R_t_composite_het_hom.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'R_a_over_R_t_composite_het_hom.png'),dpi=1000)
