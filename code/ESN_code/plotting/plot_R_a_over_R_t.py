...
def plot(ax,input_type,adapt_mode):
    ...
    sweep_df["specrad/R_t"] = sweep_df["specrad"] / sweep_df["R_t"]

    sns.lineplot(ax=ax,data=sweep_df,x="sigm_e",y="specrad/R_t",hue="r_t_cat",legend="full",palette="viridis",hue_norm=(0.5,1.8))
