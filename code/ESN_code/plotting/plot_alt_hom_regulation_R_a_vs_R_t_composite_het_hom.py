...
import ESN_code.plotting.plot_alt_hom_regulation_R_a_vs_R_t as plot_R_a_vs_R_t
...
plot_R_a_vs_R_t.plot(ax4,'homogeneous_independent_gaussian','local')

plot_R_a_vs_R_t.plot(ax3,'homogeneous_identical_binary','local')
...
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_R_a_vs_R_t_composite_het_hom.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_R_a_vs_R_t_composite_het_hom.png'),dpi=1000)
