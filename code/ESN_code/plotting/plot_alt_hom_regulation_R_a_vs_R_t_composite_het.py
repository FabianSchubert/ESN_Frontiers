...
#plot_R_a_vs_R_t.plot(ax4,'heterogeneous_independent_gaussian','global')

#plot_R_a_vs_R_t.plot(ax3,'heterogeneous_identical_binary','global')
...
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_R_a_vs_R_t_composite_het.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_R_a_vs_R_t_composite_het.png'),dpi=1000)
