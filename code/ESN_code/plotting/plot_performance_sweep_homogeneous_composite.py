...
plot_alt_hom_regulation_performance_sweep.plot(ax1,'homogeneous_identical_binary','local')

print("plotting performance sweep homogeneous_independent_gaussian...")
plot_performance_sweep.plot(ax4,'homogeneous_independent_gaussian')
plot_alt_hom_regulation_performance_sweep.plot(ax3,'homogeneous_independent_gaussian','local')
...
fig.savefig(os.path.join(PLOT_DIR,'performance_sweep_homogeneous_composite.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'performance_sweep_homogeneous_composite.png'),dpi=300)
