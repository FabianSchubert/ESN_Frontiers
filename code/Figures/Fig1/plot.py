...
r_a.plot(ax1,os.path.dirname(__file__)+"/data/sim_data.npz",col=colors[0],skip_steps=5)
...
fig.savefig(os.path.dirname(__file__)+'/Fig1.pdf')
fig.savefig(os.path.dirname(__file__)+'/Fig1.png',dpi=1000)
